...
if(isset($_POST['proceedToPlaceBtn']))
{
    ...
    if($checkCustomer) {
        if(mysqli_num_rows($checkCustomer) > 0) {
            ...
            jsonResponse(200, 'success', 'Customers Found');
        }
        else{
            $_SESSION['cphone'] = $phone;
            jsonResponse(404, 'warning', 'Customers Not Found');
        }
    } else {
        jsonResponse(500, 'error', 'Something went wrong');
    }
...
if(isset($_POST['saveOrder']))
{
    ...
    if(mysqli_num_rows($checkCustomer) > 0)
    {
        ...
        foreach($sessionProducts as $prodItem) {
            ...
            $orderItemQuery = insert('orders_item', $dataOrderItem);
        ...
        jsonResponse(200, 'success', 'Order Placed Succesfully');
    } else {
