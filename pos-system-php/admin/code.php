    ...
    if($name != '' && $email != '' && $password != '') {
        ...
        if($emailCheck) {
            if(mysqli_num_rows($emailCheck) > 0) {
                redirect('admins-create.php', 'Email alredy used by another user.');
            }
        }
...
if(isset($_POST['updateAdmin'])) {
    ...
    if($adminData['status'] != 200) {
        redirect('admins-edit.php?id='.$adminId,'Please fill required fileds.');
    }
    ...
    if($checkResult) {
        if(mysqli_num_rows($checkResult) > 0) {
            redirect('admins-edit.php?id='.$adminId,'Email Alredy used by another user');
        }
    }
...
if(isset($_POST['saveCategory'])) {
    ...
    if($result) {
        redirect('kategori.php', 'Kategori Created Succesfully');
    } else {
        redirect('kategori-create.php', 'Something Went Wrong');
    }
}
...
if(isset($_POST['updateCategory'])){
    ...
    if($result) {
        redirect('kategori-edit.php?id='.$categoryId, 'Kategori Updated Succesfully');
    } else {
        redirect('kategori-edit.php?id='.$categoryId, 'Something Went Wrong');
    }
